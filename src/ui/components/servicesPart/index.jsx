            ...
            <Col  className = "mb-4" xs = "12" sm = "6">
                <Card>
                    ...
                    <div className="action-part text-center mt-3">
                      <Button href = "/services/photography" shape = "round" className = "mt-3" style = {{width:"30%", borderColor:"green",color:"green"}} > Learn More</Button>
                    </div>
                </Card>
            </Col>
                        <Col  className = "mb-4" xs = "12" sm = "6">
                <Card>
                    ...
                    <div className="action-part text-center mt-3">
                      <Button href = "/mobile-and-web-developement" shape = "round" className = "mt-3" style = {{width:"30%", borderColor:"green",color:"green"}} > Learn More</Button>
                    </div>
                </Card>
            </Col>
                        <Col  className = "mb-4" xs = "12" sm = "6">
                <Card>
                    ...
                    <div className="action-part text-center mt-3">
                      <Button href = "/services/event-planning"  shape = "round" className = "mt-3" style = {{width:"30%", borderColor:"green",color:"green"}} > Learn More</Button>
                    </div>
                </Card>
            </Col>
                        <Col  className = "mb-4" xs = "12" sm = "6">
                <Card>
                    ...
                    <div className="action-part text-center mt-3">
                      <Button href = "/services/graphic-design" shape = "round" className = "mt-3" style = {{width:"30%", borderColor:"green",color:"green"}} > Learn More</Button>
                    </div>
                </Card>
            </Col>
