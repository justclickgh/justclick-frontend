    ...
    return (
      ...
      >
        ...
        <Form.Item
         ...
         >
          <Select se onChange = {props.handleJobCategoryChange} value = {props.job_category}>
            ...
            <Select.Option value="EVENT PLANNING">Photography</Select.Option>
            <Select.Option value="PHOTOGRAPHY">Mobile/Web Design</Select.Option>
            <Select.Option value="WEB/MOBILE DEVELOPMENT">Event Planning</Select.Option>
          </Select>
        </Form.Item>
        <Form.Item
         label="Description"
        ...
        //  label="Job Type"
         ...
         >
          <DatePicker name = "due_date" value ={props.dueDate} onChange = {props.handleDateChange} required />
        </Form.Item>
...
export default connect(mapStateToProps,mapDispatchToProps)(JobsFormModal)
